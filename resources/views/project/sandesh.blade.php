...
@section('main')
    <div id="inner">
        <section class="nmb behind-header">
            <div class="hero">
                <div style="background-image: url({{ asset('images/hero/sandeshboedhoe.jpg') }})" class="bg faded"></div>
                <div class="vcenter">
                    <div class="container mb-xl">
                        <div class="grid">
                            ...
                            <div class="col-7">
                                ...
                                <h1 class="animatedText">Sandesh</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                        <div class="video-frame mb-xl">--}}
                            <img src="{{ asset('images/projects/single/sandeshboedhoe.jpg') }}" alt="">
{{--                        </div>--}}
                    </div>
                </div>
                <div class="grid content">
